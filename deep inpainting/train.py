...
def load_data(batch_size):
    ...
    train_path = "data/flowers_40/train/"
    train_path_masked = "data/flowers_40_masked/train/"
    val_path = "data/flowers_40/val/"
    val_path_masked = "data/flowers_40_masked/val/"
    ...
    for epoch in range(epochs):
        ...
        if (N % (eval_every) == 0):
            ...
            if len(val_loss_list) > 0 and val_loss < best_last_time:
                ...
                torch.save(model, "./models/model_lr_{}_bs_{}_epochs_{}_net_{}.pt".format(lr,batch_size,epochs,"2"))
            val_loss_list.append(val_loss)
            train_loss_list.append(accum_loss/len(train_loader))
